...
/**
 * xFrameworkPX_Config_GlobalTest Class File
 *
 * PHP versions 5
 *
 * @category   Tests
 ...
 * @version    SVN $Id: GlobalTest.php 931 2009-12-24 10:42:44Z tamari $
 */
...
require_once 'xFrameworkPX/Config/Global.php';
...
/**
 * xFrameworkPX_Config_GlobalTest Class
 *
 * @category   Tests
 * @package    xFrameworkPX_Config
 * @author     Kazuhiro Kotsutsumi <kotsutsumi@xenophy.com>
 ...
 */
class xFrameworkPX_Config_GlobalTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetInstance()
    {
        ...
        $this->assertType(
            ...
            xFrameworkPX_Config_Global::getInstance()
        );
