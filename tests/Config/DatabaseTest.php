...
/**
 * xFrameworkPX_Config_DatabaseTest Class File
 *
 * PHP versions 5
 *
 * @category   Tests
 ...
 * @version    SVN $Id: DatabaseTest.php 931 2009-12-24 10:42:44Z tamari $
 */
...
require_once 'xFrameworkPX/Config/Database.php';
...
/**
 * xFrameworkPX_Config_DatabaseTest Class
 *
 * @category   Tests
 * @package    xFrameworkPX_Config
 * @author     Kazuhiro Kotsutsumi <kotsutsumi@xenophy.com>
 ...
 */
class xFrameworkPX_Config_DatabaseTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetInstance()
    {
        ...
        $this->assertType(
            ...
            xFrameworkPX_Config_Database::getInstance()
        );
